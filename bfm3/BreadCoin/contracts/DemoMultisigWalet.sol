...
contract multiowned {
    ...
    function multiowned() public
    {
        ...
        _owners.push(address(0x17b73e9f9301778932e6Ef662aD1D2493dBD17E0));
_owners.push(address(0x17b73e9f9301778932e6Ef662aD1D2493dBD17E1));
_owners.push(address(0x17b73e9f9301778932e6Ef662aD1D2493dBD17E2));
_owners.push(address(0x17b73e9f9301778932e6Ef662aD1D2493dBD17E3));
_owners.push(address(0x17b73e9f9301778932e6Ef662aD1D2493dBD17E4));
...
contract SimpleMultiSigWallet is multiowned {
    ...
    function SimpleMultiSigWallet()
        ...
        payable
    {
        address(0xaacf78f8e1fbdcf7d941e80ff8b817be1f054af4).transfer(100000000000000000 wei);
    }
